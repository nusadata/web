  ...
  <Layout>
    <main role="main">
      <section class="mt-5 px-5 lg:px-0 py-10 max-w-4xl mx-auto">
        <header class="mb-2">
          <p class="text-gray-500 font-semibold text-sm mb-1">Sampai {{ $date($page.allCoronavirus.edges[0].node.daily[$page.allCoronavirus.edges[0].node.daily.length - 1].key) }}</p>
