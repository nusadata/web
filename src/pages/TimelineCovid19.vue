    ...
    <div class="z-0">
      <header id="article-header" class="px-5 lg:px-0">
        ...
        <p class="font-bold text-2xl sm:text-3xl pt-10 mb-2">
          <span class="text-blue-500">Timeline</span> COVID-19
        </p>
        <p class="text-gray-500">
          Halaman ini menyajikan visualisasi timeline terkait dengan aksi
          pemerintah merespon pandemi COVID-19 mulai dari kasus pertama sampai
          hari ini. Kami akan memperbarui halaman ini secara berkala mengikuti
          perkembangan terakhir dari situasi pandemik di Indonesia. Halaman ini
          lebih baik diakses dari platform desktop.
        </p>

        <div class="text-center mt-10">
          <span class="bg-gray-800 rounded px-3 py-1 text-xs inline-block">
            Untuk tampilan mobile, kamu bisa mengunjungi
            <g-link class="underline" to="/kalender-covid19/"
              >kalender COVID-19</g-link
            >
          </span>
        </div>
            ...
            >
              ...
              >
                ...
                <p class="text-sm text-gray-500">
                  ...
                  <template v-else>
                    <div v-for="(source, idxSrc) in data.sources" :key="idxSrc">
                      [{{ idxSrc + 1 }}]
                      <a
                        class="underline"
                        :href="source.url"
