          ...
          svg
            ...
            .attr('transform', function (_d, _i) {
              ...
              self.$d3
                ...
                .select('text')
                .text(
                  self.$delimiter(Math.ceil(y.invert(y(confirmed[idx].jumlah_positif.value))))
                )

              return `translate(${x(
                new Date(confirmed[idx].key)
              )}, ${y(confirmed[idx].jumlah_positif.value)})`
            })
          ...
          svg
            ...
            .attr('transform', function (_d, _i) {
              ...
              self.$d3
                ...
                .select('text')
                .text(
                  self.$delimiter(Math.ceil(y.invert(y(confirmed[idx].jumlah_sembuh.value))))
                )

              return `translate(${x(
                new Date(confirmed[idx].key)
              )}, ${y(confirmed[idx].jumlah_sembuh.value)})`
            })
          ...
          svg
            ...
            .attr('transform', function (_d, _i) {
              ...
              self.$d3
                ...
                .select('text')
                .text(
                  self.$delimiter(Math.ceil(y.invert(y(confirmed[idx].jumlah_meninggal.value))))
                )

              return `translate(${x(
                new Date(confirmed[idx].key)
              )}, ${y(confirmed[idx].jumlah_meninggal.value)})`
            })
        })
