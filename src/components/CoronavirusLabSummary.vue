  ...
  <section :class="`max-w-4xl mb-10 mx-auto overflow-x-hidden`">
    <header>
      ...
      <p class="mx-5 lg:mx-0 mb-5 text-gray-500">
        There are three types of COVID-19 testing conducted by the government: rapid test, polymerase chain reaction (PCR) and 'test cepat molekuler' (TCM). Rapid test is usually performed as a screening procedure, and it only takes about 10-15 minutes (<a class="underline" href="https://www.alodokter.com/kenali-apa-itu-rapid-test-untuk-virus-corona" target="__blank" rel="nofollow noreferrer">alodokter</a>). If a rapid test result is positive, then the person should undergone PCR test which could takes about 1-3 days (<a class="underline" href="https://katadata.co.id/berita/2020/03/16/unair-dan-eijkman-jadi-laboratorium-corona-berapa-lama-hasil-tesnya" target="__blank" rel="nofollow noreferrer">katadata</a>). To complement rapid test and PCR test, the government also makes use of tuberculosis examination machine or TCM which are already available in 132 hospitals across the country (<a class="underline" href="https://health.detik.com/berita-detikhealth/d-4961437/pemerintah-ri-akan-pakai-mesin-pemeriksaan-tbc-untuk-tes-virus-corona" target="__blank" rel="nofollow noreferrer">detik.com</a>).
      </p>
    </header>
